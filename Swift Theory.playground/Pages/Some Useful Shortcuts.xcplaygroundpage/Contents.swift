///# Change View Modal transition in to full screen transition with back button
// Select the VC(yellow button) -> Editor -> Embed in -> Navigation controller


///# All the way to root VC
